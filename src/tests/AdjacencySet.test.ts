...
describe('AdjacencySet', () => {
    let ydoc1: Y.Doc
    let yMatrix1: AdjacencySet
    let ydoc2: Y.Doc
    let yMatrix2: AdjacencySet
    ...
    beforeEach(() => {
        ydoc1 = new Y.Doc()
        yMatrix1 = new AdjacencySet(ydoc1.getMap('adjacency set'))
        ydoc2 = new Y.Doc()
        yMatrix2 = new AdjacencySet(ydoc2.getMap('adjacency set'))
    })
